...
const LeftSide = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center gap-2 pt-7 justify-center dark:bg-gray-g800">
            ...
            <div>
                <ul className="list-none flex flex-col ">
                    <li className="listyle">
                        <Link href="/about">
                            <a className={router.pathname == '/about' ? "active" : "menua"} >
                    ...
                    <li className="listyle">
                        <Link href="/portfolio">
                            <a className={router.pathname == '/portfolio' ? "active" : "menua"}>
                    ...
                    <li className="listyle">
                        <Link href="/resume">
                            <a className={router.pathname == '/resume' ? "active" : "menua"}>
                    ...
                    <li className="listyle">
                        <Link href="/skills">
                            <a className={router.pathname == '/skills' ? "active" : "menua"}>
                    ...
                    <li className="listyle">
                        <Link href="/contactme">
                            <a className={router.pathname == '/contactus' ? "active" : "menua"}>
