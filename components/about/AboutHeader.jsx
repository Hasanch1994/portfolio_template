        ...
        <div className="flex flex-col w-full h-auto dark:bg-gray-g800 bg-gray-g50 p-14">
            <div className="md:block flex w-full align-middle ">
                <div className="md:w-full w-2/3 flex flex-col ml-3 md:ml-0 md:items-center">
                    ...
                    <p className="text-gray-g600 dark:text-gray-g200 text-base mt-4 text-left md:text-center mr-6">
                        I'm a software engineer specialised in frontend and backend development for complex scalable web apps. I write about software development on my blog. Want to know how I may help your project? Check out my project <Link href="/portfolio" className="insidea">portfolio </Link>and online <Link href="/resume" className="insidea">resume </Link> .
                    </p>

                    <div className="md:w-full w-3/4 flex md:justify-center items-center mt-16">
                        ...
                        <Link href="/resume"><button className="graybutton ml-3">
                ...
                <div className="md:w-full md:mt-4 w-1/3 flex-col flex md:items-center">
                    <Image src="/images/profileimage.jpg" className="overflow-hidden" width="400" height="300" alt="Hasan Cheraghi image" />
                </div>
            </div>
        </div>
